...
internal static class Logger
{
	...
	internal static void Log(string message) => CraftingRevisionsMod.instance.LoggerInstance.Msg(message);

	//Warning Messages show in yellow
	internal static void LogWarning(string message) => CraftingRevisionsMod.instance.LoggerInstance.Warning(message);

	//Error Messages show in red
	internal static void LogError(string message) => CraftingRevisionsMod.instance.LoggerInstance.Error(message);
	...
	//Blue Messages
	internal static void LogBlue(string message) => CraftingRevisionsMod.instance.LoggerInstance.Msg(ConsoleColor.Blue, message);

	//Green Messages
	internal static void LogGreen(string message) => CraftingRevisionsMod.instance.LoggerInstance.Msg(ConsoleColor.Green, message);
